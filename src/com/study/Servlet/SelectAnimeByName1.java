...
@WebServlet("/SelectAnimeByName1")
public class SelectAnimeByName1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 转发到结果显示的 JSP 页面
        request.getRequestDispatcher("dongmanAdmin1.jsp").forward(request, response);
    }
