...
<body>
<center>
    <h1><a href="https://www.bilibili.com/video/BV19u4m1T7Mk/?spm_id_from=333.788&vd_source=2966c37b095e634bd3cb613b94d54827">四月新番信息</a></h1>
    <hr width="100%">
    <form>
        <table >
            <tr>
            ...
            <tr align="center">
                ...
                <td><input name="director" value="<%=b%>"   readonly/></td>
                <td><input name="scriptwriter" value="<%=c%>"  readonly/></td>
                <td><input name="dub" value="<%=d%>"  readonly/></td>
                <td><input name="music" value="<%=e%>"   readonly/></td>
                <td><input name="time" value="<%=f%>"  readonly/></td>
                <td><input name="episode" value="<%=g%>"  readonly/></td>
            </tr>
                    <%
          }
